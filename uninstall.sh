...
echo -e "  ${GRAY}La carpeta config/ (settings.yaml, mediamtx.yml, license.lic,${NC}"
echo -e "  ${GRAY}.device_fingerprint, .clock_state, .license_activated_at, .env)${NC}"
echo -e "  ${GRAY}tampoco se tocó, ni los respaldos en /var/backups/go2-xvr/.${NC}"
echo ""